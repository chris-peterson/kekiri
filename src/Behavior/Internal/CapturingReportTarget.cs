...
/// <summary>
/// A scenario's Gherkin text is already modelled through IReportTarget, for console and .feature
/// output. Capturing it instead is what lets the runner put the steps on the test node.
/// </summary>
